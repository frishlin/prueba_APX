...
/**
 * Test for transaction WIKJT88801MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT88801MXTest.xml" })
public class WIKJT88801MXTransactionTest {

	@Autowired
	private WIKJT88801MXTransaction transaction;
